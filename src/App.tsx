...
import PostHeroSectionInfoSection from './components/post-hero-section-info-section';

function App() {
  return (
    <div className="bg-black pt-20 sm:pt-32 h-auto">
      <Navbar />
      <div className="container mx-auto px-4 sm:px-6 lg:px-0 lg:max-w-6xl pb-10 sm:pb-20 border-2 border-gray-300/10">
        <div className="border-b-2 border-gray-300/10 mb-3 sm:mb-5">
          <HeroSection />
        </div>
        <PostHeroSectionInfoSection />
