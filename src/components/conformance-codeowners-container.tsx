...
const ConformanceCodeownersContainer = () => {
  return (
    <div className="bg-gradient-to-b from-white/15 to-transparent rounded-2xl flex flex-col sm:flex-row p-px space-y-[1px] sm:space-y-0 sm:space-x-[1px]">
      <div className="flex-1 flex flex-col gap-y-2 bg-black rounded-t-2xl sm:rounded-l-2xl sm:rounded-tr-none p-3 sm:p-4 bg-gradient-to-b from-white/5 to-transparent">
      ...
      <div className="flex-1 flex flex-col gap-y-2 bg-black rounded-b-2xl sm:rounded-r-2xl sm:rounded-bl-none p-3 sm:p-4 bg-gradient-to-b from-white/5 to-transparent">
        <div className="py-1 sm:py-2">
          <p className="font-medium text-white/90 text-sm sm:text-base">
            Code Owners
          </p>
      ...
      <div className="flex gap-x-1 sm:gap-x-2 items-center px-1 sm:px-2">
        {contributors.map((c, index) => (
          <img
            key={index}
            src={c.avatarUrl}
            className={`w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-gray-100 border border-gray-800 ${
