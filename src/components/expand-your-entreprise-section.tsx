...
export const ExpandYourEntrepriseSection = () => {
  return (
    <div className="h-auto w-full flex flex-wrap items-center justify-center text-lg md:text-3xl font-medium text-white gap-4 px-4 py-6 border-t-2 border-gray-300/10 text-center">
